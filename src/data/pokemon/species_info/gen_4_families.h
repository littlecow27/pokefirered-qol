...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_GUTS, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_FLARE_BOOST, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_LIMBER, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_LIMBER, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_TOXICROAK}),
    },
