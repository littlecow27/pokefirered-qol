...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_SHED_SKIN, ABILITY_NONE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_VIKAVOLT}),
    },
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_SPEED_BOOST, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_SWEET_VEIL, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NO_GUARD, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        .abilities = { ABILITY_LIMBER, ABILITY_REGENERATOR, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BLUE,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_BRUXISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_DAZZLING, ABILITY_WONDER_SKIN, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_PINK,
